...
import uebung05sol.funcs.Cosinus;
import uebung05sol.funcs.Poly3;
import uebung05sol.funcs.Sinus;
...
public class FunctionPlotter extends JFrame implements ActionListener, Observer {
	...
	public FunctionPlotter() {
		super("Function Plotter Solution");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (src==_jb_sinus) {
			_pm.setFunction(new Sinus());
		} else if (src==_jb_cosinus) {
			_pm.setFunction(new Cosinus());
		} else if (src==_jb_poly3) {
			_pm.setFunction(new Poly3(1.0, -3.0, -1.0, 3.0));
